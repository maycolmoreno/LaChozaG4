...
import com.lachozag4.consumochoza.modelo.dto.LoginResponseDTO;

import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpSession;

/**
 * AuthenticationProvider que delega la autenticaciÃ³n a la API REST (pisip).
...
public class ApiAuthenticationProvider implements AuthenticationProvider {
    ...
    public ApiAuthenticationProvider(@Value("${api.base-url}") String apiBaseUrl,
        ...
        // WebClient independiente sin filtro de JWT (el login es pÃºblico)
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            // Guardar el JWT en la sesiÃ³n HTTP
            ...
            throw new BadCredentialsException("Error de comunicaciÃ³n con la API: " + e.getMessage());
        }
    }
