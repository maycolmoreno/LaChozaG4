...
public class UsuarioControlador {
    ...
    public String guardar(@ModelAttribute UsuarioDTO usuario, Model model) {
        try {
            ...
            if (mensaje != null && mensaje.toLowerCase().contains("username")) {
                model.addAttribute("mensajeError", "âš ï¸ Ya existe un usuario con ese username. Por favor ingrese uno diferente.");
            } else {
                model.addAttribute("mensajeError", "âš ï¸ " + (mensaje != null ? mensaje : "Error al guardar el usuario"));
            }
    ...
    public String cambiarPassword(@RequestParam("passwordActual") String passwordActual,
        ...
        if (!passwordNuevo.equals(confirmarPasswordNuevo)) {
            model.addAttribute("mensajeError", "La nueva contraseÃ±a y su confirmaciÃ³n no coinciden.");
            model.addAttribute("passwordActual", "");
            model.addAttribute("passwordNuevo", "");
            model.addAttribute("confirmarPasswordNuevo", "");
            return "Usuario/CambiarPassword";
        ...
        if (username == null) {
            redirectAttributes.addFlashAttribute("mensajeError",
                    "No se pudo identificar al usuario actual. Inicie sesiÃ³n nuevamente.");
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("mensajeExito",
                    "ContraseÃ±a actualizada correctamente. Vuelva a iniciar sesiÃ³n con su nueva clave.");
