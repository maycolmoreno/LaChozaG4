...
public class MesaControlador {
    ...
    public String guardar(@ModelAttribute MesaDTO mesa, Model model) {
        try {
            ...
            if (mensaje != null && mensaje.toLowerCase().contains("numero") || mensaje != null && mensaje.toLowerCase().contains("nÃºmero")) {
                model.addAttribute("mensajeError", "âš ï¸ Ya existe una mesa con ese nÃºmero. Por favor ingrese uno diferente.");
            } else {
                model.addAttribute("mensajeError", "âš ï¸ " + (mensaje != null ? mensaje : "Error al guardar la mesa"));
            }
