...
public class ClienteControlador {
    ...
    public String listar(
        ...
        // BÃºsqueda por nombre, cÃ©dula, telÃ©fono o email
    ...
    public String guardar(@ModelAttribute ClienteDTO cliente, Model model) {
        try {
            ...
            // ValidaciÃ³n especÃ­fica para datos duplicados
            String mensaje = e.getMessage();
            if (mensaje != null && (mensaje.toLowerCase().contains("email") || mensaje.toLowerCase().contains("correo"))) {
                model.addAttribute("mensajeError", "âš ï¸ El correo ingresado ya estÃ¡ registrado. Por favor ingrese uno diferente.");
            } else if (mensaje != null && mensaje.toLowerCase().contains("cedula")) {
                model.addAttribute("mensajeError", "âš ï¸ La cÃ©dula ingresada ya estÃ¡ registrada. Por favor ingrese una diferente.");
            } else {
                model.addAttribute("mensajeError", "âš ï¸ " + (mensaje != null ? mensaje : "Error al guardar el cliente"));
            }
