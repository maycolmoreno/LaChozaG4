 ...
 * Separado de los controladores MVC para respetar el principio de responsabilidad Ãºnica (SRP).
 */
@RestController
...
public class PosApiControlador {
    ...
    /**
     * Busca clientes por nombre o cÃ©dula para el autocompletado del POS.
     */
    ...
    /**
     * Crea un cliente rÃ¡pido desde el POS (modal de nuevo cliente).
     */
    ...
    /**
     * Obtiene los pedidos activos (PENDIENTE, EN_COCINA o LISTO_PARA_ENTREGA) de una mesa especÃ­fica.
     */
    ...
    /**
     * Cambia el estado de un pedido vÃ­a AJAX (ej. enviar a cocina desde el POS).
     */
    ...
    /**
     * Resumen rÃ¡pido de ventas del dÃ­a para el header del POS.
     */
